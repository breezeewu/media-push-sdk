...
#define SUN_MUTEX       std::recursive_mutex
#define SUN_AUTO_LOCK   std::lock_guard<recursive_mutex>
//#define WRITE_INPUT_VIDEO_RECORD
//#define WRITE_OUTPUT_VIDEO_RECORD

//#define __STDC_FORMAT_MACROS
#define SDK_VERSION_MAYJOR	2
#define SDK_VERSION_MINOR	4
#define SDK_VERSION_MACRO	0
#define SDK_VERSION_TINY	0
#define ENABLE_BUFFER_MEDIA_DATA
...
//#define BASE_STATION_TEST
//#define ENABLE_TIME_LOG_DEBUG
#define BEGIN_DUR_TIME unsigned long begin = GetSysTime();//TimeCounter durtime = TimeCounter(10);
#define PRINTF_DUR_TIME(dur) if(GetSysTime() - begin > dur) sv_warn("durtime exceed %d, spend time:%ld", dur, GetSysTime() - begin);//durtime.printf_time_if();
// write media data micro define
#define ENABLE_DEBUG    1
#if ENABLE_DEBUG
//#define READ_RTMP_MSG_FILE
//#ifndef READ_RTMP_MSG_FILE
#ifdef BASE_STATION_TEST
//#define WRITE_AVC_DATA_FILE
//#define WRITE_AAC_DATA_FILE
#endif
//#define WRITE_RTMP_DATA_FILE
//#define SEND_PACKET_DIRECTORY

//#define READ_AVC_DATA_FILE
//#define READ_AAC_DATA_FILE
//#define READ_AVC_MSG_FILE
//#define READ_AAC_MSG_FILE
//#define READ_RTMP_MSG_FILE
//#define WIRTE_RTMP_MSG_FILE
//#define READ_RAW_MEDIA_FILE
//#endif
//#define READ_IPC_RECORD_FILE
//#define WRITE_FLV_AVC_FILE
//#define WRITE_FLV_AAC_FILE
//#define WRITE_ORG_DATA_ONLY
//#define WRITE_SEND_SOCKET_DATA
#endif
#define SV_INVALID_TIMESTAMP    (-__INT64_C(9223372036854775807)-1)//INT64_MIN 
#define MIN_FRAME_BUFFER_SIZE   64 * 1024

#define CACHE_MEDIA_DATA_IMMEDIATELY
#ifdef CACHE_MEDIA_DATA_IMMEDIATELY
#define MUXER_AND_SEND_FRAME_TOGETHER
#endif
...
// utility
#define CheckPtr(p, ret) if(NULL == p) { sv_error("checkptr failed, p:%p", p); return ret;}
#define CheckMemory(p) if(NULL == p) { sv_error("out of memory, memory malloc failed!"); return ERROR_OUT_OF_MEMORY;}
#define CheckResult(ret) if(ret != 0) { sv_error("checkreulst failed, ret:%d", ret); return ret;}
#define CheckFailed(ret) ret != 0 ? 1:0
//#define SV_FREE_ARRAY(p)  if(p)   {delete[] p; p = NULL;}
// error code
...
#define ERROR_INIT_FAIL             -3
#define ERROR_OPEN_FILE_FAIL        -4
#define ERROR_BUFFER_NOT_ENOUGH     -5
#define ERROR_NOT_INIT              -6
#define ERROR_OUT_OF_MEMORY         -7
#define ERROR_SERVER_DISCONNECT     -8
#define ERROR_NO_SPS_AND_PPS        -9
#define ERROR_NO_ADTS_HEADER        -10

//socket timeout
//#define ERROR_SOCKET_TIMEOUT       -100
#define ERROR_SOCKET_INVALID       -101

#define SERVER_RESPONSE_SUCCESS             88
///////////////////////////////////////////////////////
// system error.
///////////////////////////////////////////////////////
...
#define ERROR_SYSTEM_ASSERT_FAILED       ENABLE_ENCRYPTION   -1021
...
#define ERROR_RTMP_CONNECTION_LOSS          -2050
